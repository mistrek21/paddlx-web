// src/app/court/[slug]/_components/CourtArticles.tsx
...
export default function CourtArticles({ court }: { court: CourtDetail }) {
	// Extract the club slug from the court object
	// Assuming court has a slug property - adjust based on your data structure
	const clubSlug = court.slug; // or court.id, depending on your schema
		...
		<div className="mb-8">
			<div className="mb-6">
				...
				<p className="text-medium-gray mt-1">
					Latest news and announcements from the club
				</p>
			</div>
			...
			{court.articles && court.articles.length > 0 ? (
				<div className="space-y-4">
					{court.articles.map((article) => {
						// Build the dynamic route: /[clubSlug]/article/[articleSlug]
						const articleUrl = `/court/${clubSlug}/article/${article.slug}`;
