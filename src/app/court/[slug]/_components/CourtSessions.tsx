				...
				{court.sessions && court.sessions.length > 0 ? (
					court.sessions.map((session) => (
						<Link
							...
							className="group block bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-primary/20"
						>
							<div className="p-6">
