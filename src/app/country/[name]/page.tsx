					...
					<div className="container mx-auto max-w-7xl">
						...
						<div className="flex flex-wrap gap-6 text-white/90">
							...
							<div className="flex items-center gap-2">
								...
								<span className="text-lg font-medium">{country.courts} Courts</span>
							</div>
							<div className="flex items-center gap-2">
								<Calendar className="w-5 h-5" />
								<span className="text-lg font-medium">{country.games} Games</span>
							</div>
						</div>
					</div>
				</div>
			...
			<div className="container mx-auto max-w-7xl px-4 py-16">
				<div className="mb-12">
					...
					<p className="text-lg text-gray-600">
						Explore pickleball courts and games across {country.cities.length} cities
					</p>
				</div>
...
export async function generateMetadata({ params }: CountryPageProps) {
	...
	return {
		...
		description: `Discover ${country.locations} pickleball locations and ${country.courts} courts across ${country.cities.length} cities in ${country.name}. Find games and connect with players.`,
	};
}
