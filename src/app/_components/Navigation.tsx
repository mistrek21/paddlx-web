				...
				<div className="max-w-7xl mx-auto flex items-center justify-between">
					...
					<div className="flex items-center gap-4">
						<button
							...
							className="text-sm font-semibold text-dark-slate hover:text-accent transition-colors"
						>
							Log in
						</button>
						<Button
							onClick={() => openModal('Join for free')}
							className="bg-accent hover:bg-accent-dark text-white font-bold px-6 rounded-full shadow accent-cta"
						>
							Join for free
						</Button>
					</div>
