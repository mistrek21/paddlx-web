...
export function RoundRobinSection() {
	...
	return (
		<section className="py-16 px-4 bg-gradient-to-b bg-primary-ultra-soft ">
			<div className="max-w-7xl mx-auto">
				...
				<div className="flex flex-col lg:flex-row items-start justify-between gap-8 mb-12">
					<div className="flex-1">
						...
						<p className="text-dark-slate leading-relaxed mb-6 max-w-2xl">
							Add a fun twist to your weekly games with our{' '}
							<span className="font-semibold text-accent">free round robin tool</span>.
						...
						<ul className="space-y-4">
							{features.map((feature, index) => (
								<li key={index} className="flex items-start gap-3">
									...
									<span className="text-dark-slate font-medium">{feature.text}</span>
								</li>
							))}
						</ul>
					</div>
					<div className="flex-shrink-0">
						<Link
							href="/round-robin"
							className="bg-accent hover:bg-accent-dark text-white font-semibold px-6 py-3 rounded-lg transition-colors inline-block shadow"
						>
							Learn more
						</Link>
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
					<div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow border border-primary-super-soft">
						...
						<p className="text-dark-slate text-sm mb-3">
							Use the simulator to understand how each round robin format works.
						</p>
						<Link
							href="/preview"
							className="text-primary font-semibold hover:text-accent text-sm inline-flex items-center gap-1"
						>
							Try it now
				...
				{/* Video */}
				<div className="bg-white rounded-lg p-6 shadow-sm border-2 border-primary-super-soft">
					<div className="flex flex-col sm:flex-row items-center justify-between gap-4">
						<div className="flex items-center gap-4">
							<div className="w-16 h-16 bg-primary-ultra-soft rounded-lg flex-shrink-0 overflow-hidden relative">
								<Image
							...
							<div>
								...
								<p className="text-dark-slate text-sm">
									...
									<span className="font-semibold text-accent">10 formats</span> and what
									running a round robin looks like on paddlx!
								</p>
							</div>
						</div>
						<Link
							href="/videos"
							className="bg-primary hover:bg-primary-light text-white font-semibold px-6 py-2.5 rounded-full border-2 border-primary transition-colors whitespace-nowrap shadow"
						>
							Watch now
						</Link>
					</div>
